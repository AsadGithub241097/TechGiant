...
const SecurityCard: React.FC<SecurityCardProps> = ({
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <h2 className="text-xl font-medium mt-4 mb-2 text-white ">{title}</h2>
      <div className="w-12 h-1 bg-carousel2 mb-4"></div>
      <p className="text-white mb-4 font-doto">{description}</p>
  ...
  const securityCards = [
    {
      ...
      imageUrl: IMAGE_URLS.operationCenter, // Replace with actual URL
    },
    {
      ...
      imageUrl: IMAGE_URLS.securityOperations, // Replace with actual URL
    },
    {
      ...
      buttonText: "Explore Security Operations as a platform",
      imageUrl: IMAGE_URLS.responseForensics, // Replace with actual URL
    },
    {
      ...
      buttonText: "Explore Security Operations as a platform",
      imageUrl: IMAGE_URLS.patchManagement, // Replace with actual URL
    },
    {
      ...
      buttonText: "Explore Security Operations as a platform",
      imageUrl: IMAGE_URLS.detectionResponse, // Replace with actual URL
    },
    {
      ...
      buttonText: "Explore Security Operations as a platform",
      imageUrl: IMAGE_URLS.securityTesting, // Replace with actual URL
    },
  ];
